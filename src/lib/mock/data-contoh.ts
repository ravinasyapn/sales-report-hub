/**
 * ============================================================================
 * DATA CONTOH — Fallback ketika backend belum tersedia
 * ============================================================================
 * Data ini DIPAKAI OTOMATIS hanya jika request ke backend mengembalikan array
 * kosong (lihat `src/lib/kasir/penyimpanan.ts` → `actions.syncAll`).
 *
 * Setelah backend menyediakan data asli, file ini tidak akan tampil lagi
 * di UI — boleh dibiarkan sebagai referensi struktur, atau dihapus saat
 * deployment production.
 * ============================================================================
 */
import type { ApiCategory, ApiProduct, ApiTransaction } from "@/lib/kasir/api";
